...
GtkWidget *create_bbox(filename_textView *filename_textViewAll)
{
	...
	button = face_button("Source/emoji/1.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/2.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/3.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/4.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/5.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/6.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/7.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/8.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/9.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/10.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	gtk_container_add(GTK_CONTAINER(vbox), bbox);
	/////////

	bbox = gtk_hbox_new(FALSE, 0);
	button = face_button("Source/emoji/11.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/12.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/13.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/14.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/15.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/16.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/17.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/18.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/19.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/20.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	gtk_container_add(GTK_CONTAINER(vbox), bbox);
	////////
	bbox = gtk_hbox_new(FALSE, 0);
	button = face_button("Source/emoji/21.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/22.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/23.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/24.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/25.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/26.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/27.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/28.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/29.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/30.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	gtk_container_add(GTK_CONTAINER(vbox), bbox);
	////////
	bbox = gtk_hbox_new(FALSE, 0);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/31.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/32.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/33.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/34.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/35.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/36.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/37.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/38.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/39.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/40.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	gtk_container_add(GTK_CONTAINER(vbox), bbox);
	////////
	bbox = gtk_hbox_new(FALSE, 0);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/41.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/42.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/43.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/44.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/45.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/46.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/47.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/48.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/49.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	button = face_button("Source/emoji/50.gif", filename_textViewAll);
	gtk_box_pack_start(GTK_BOX(bbox), button, FALSE, FALSE, 0);
	gtk_container_add(GTK_CONTAINER(vbox), bbox);
	return vbox;
}
